...
LABEL org.opencontainers.image.title="semrel-plugin-hook-email" \
      org.opencontainers.image.description="semrel plugin: hook-email" \
      org.opencontainers.image.url="https://semrel.io" \
      org.opencontainers.image.source="https://github.com/SemRels/hook-email" \
