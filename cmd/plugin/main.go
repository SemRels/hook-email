...
import (
	...
	grpcserver "github.com/SemRels/hook-email/internal/grpc"
	semrelplugin "github.com/SemRels/hook-email/internal/plugin"
)

func main() {
	provider := semrelplugin.NewProvider("hook-email")
